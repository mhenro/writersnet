...
public interface BookRepository extends PagingAndSortingRepository<Book, Long> {
    ...
    @Query("SELECT new org.booklink.models.response.BookWithTextResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.author.username, b.author.firstName, b.author.lastName, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.bookText.id, b.bookText.text, b.bookText.prevText, b.author.premium, b.paid, b.cost) FROM Book b LEFT JOIN b.bookSerie WHERE b.id = ?1")
