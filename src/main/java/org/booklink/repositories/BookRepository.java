...
public interface BookRepository extends PagingAndSortingRepository<Book, Long> {
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE b.author.username = ?1 ORDER BY b.name")
    Page<BookResponse> findBooksByAuthor(final String authorId, final Pageable pageable);

    @Query("SELECT COUNT(b) FROM Book b")
    Long getBooksCount();

    @Query("SELECT new org.booklink.models.response.BookWithTextResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.author.username, b.author.firstName, b.author.lastName, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.bookText.id, b.bookText.text, b.bookText.prevText, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE b.id = ?1")
    ...
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE UPPER(b.name) LIKE CONCAT(UPPER(?1), '%') ORDER BY (b.totalRating+1) / (b.totalVotes+1) DESC, b.author.premium DESC")
    ...
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE UPPER(b.name) LIKE CONCAT(UPPER(?1), '%') AND b.genre = ?2 AND b.language = ?3 ORDER BY (b.totalRating+1) / (b.totalVotes+1) DESC, b.author.premium DESC")
    ...
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE UPPER(b.name) LIKE CONCAT(UPPER(?1), '%') AND b.genre = ?2 ORDER BY (b.totalRating+1) / (b.totalVotes+1) DESC, b.author.premium DESC")
    ...
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE UPPER(b.name) LIKE CONCAT(UPPER(?1), '%') AND b.language = ?2 ORDER BY (b.totalRating+1) / (b.totalVotes+1) DESC, b.author.premium DESC")
    ...
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE b.genre = ?1 AND b.language = ?2 ORDER BY (b.totalRating+1) / (b.totalVotes+1) DESC, b.author.premium DESC")
    ...
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE b.language = ?1 ORDER BY (b.totalRating+1) / (b.totalVotes+1) DESC, b.author.premium DESC")
    ...
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie WHERE b.genre = ?1 ORDER BY (b.totalRating+1) / (b.totalVotes+1) DESC, b.author.premium DESC")
    ...
    @Query("SELECT new org.booklink.models.response.BookResponse(b.id, b.bookSerie.id, b.bookSerie.name, b.commentsCount, b.cover, b.created, b.description, b.genre, b.language, b.lastUpdate, b.name, LENGTH(b.bookText.text), b.totalRating, b.totalVotes, b.views, b.author.username, b.author.firstName, b.author.lastName, b.author.avatar, b.reviewCount, b.author.premium) FROM Book b LEFT JOIN b.bookSerie ORDER BY (b.totalRating+1) / (b.totalVotes+1) DESC, b.author.premium DESC")
